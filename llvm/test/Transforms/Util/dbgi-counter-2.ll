; REQUIRES: asserts
; RUN: opt -debug-only=counter -S -passes=dbg-counter < %s 2>&1 | FileCheck %s  
...
!2 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus_14, file: !3, producer: "clang version 22.0.0git (https://github.com/llvm-project.git 782a91e1fc94d9c82495f60afc5ed5edd72de776)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, globals: !4, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "/tmp/test.cpp", directory: "/llvm-project", checksumkind: CSK_MD5, checksum: "1bce1e274606359bd3ee799e44db5ab7")
!4 = !{!0}
!5 = !DIFile(filename: "tmp/test.cpp", directory: "/tmp", checksumkind: CSK_MD5, checksum: "1bce1e274606359bd3ee799e44db5ab7")
...
!27 = !{!"clang version 22.0.0git (https://github.com/llvm-project.git 782a91e1fc94d9c82495f60afc5ed5edd72de776)"}
